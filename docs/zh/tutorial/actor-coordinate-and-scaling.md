...
请先下载 **[角色裁切参考模板](Konado参考框-立绘.png)**，和 **[角色定位参考模板](Konado参考框-立绘+定位.svg)**。
...
<figure>
  <center>
    <img src="屏幕截图 2026-05-16 225252.png" alt="演员定位" />
  </center>
  <figcaption style="font-size: 14px; text-align: center; color: #666;">演员定位</figcaption>
</figure>
...
<figure>
  <center>
    <img src="屏幕截图 2026-05-16 225346.png" alt="演员定位" />
  </center>
  <figcaption style="font-size: 14px; text-align: center; color: #666;">演员定位</figcaption>
</figure>
