...
Konado は軽量なビジュアルノベルエンジンフレームワークであり、豊富なダイアログテンプレートと強力なダイアログマネージャーを提供します。柔軟性を重視して設計されており、開発者はダイアログ主導のゲームを迅速に作成したり、既存のゲームプロジェクトにダイアログシステムをシームレスに統合したりすることができます。


## クイックスタート

[クイックスタートガイド](https://godothub.com/oss/konado/tutorial/install.html)に従って、数分以内に Konado をセットアップして使用を開始してください。


## ドキュメント

包括的なガイド、API リファレンス、高度なチュートリアルについては、公式プロジェクトウェブサイトをご覧ください：https://godothub.com/oss/konado
